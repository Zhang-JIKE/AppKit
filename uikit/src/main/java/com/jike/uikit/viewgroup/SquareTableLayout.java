...
public class SquareTableLayout extends BaseLayout {
    ...
    private float viewWidth = DisplayUtils.dp2px(24,getContext());
    ...
    public void init(AttributeSet attrs) {
        ...
        space = array.getDimension(R.styleable.SquareTableLayout_squaretablelayout_space, DisplayUtils.dp2px(4,getContext()));
        array.recycle();
    }
